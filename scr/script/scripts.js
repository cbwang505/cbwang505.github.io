...
{
	if (document.all){    
		document.all['XtremeCommandBars'].style.display = 'none';	
	  	document.all['XtremeDockingPane'].style.display = 'none';	
	 	document.all['XtremePropertyGrid'].style.display = 'none';	
		document.all['XtremeReportControl'].style.display = 'none';
		document.all['XtremeSuiteControls'].style.display = 'none';							
		document.all['XtremeSkinFramework'].style.display = 'none';		
		document.all['XtremeCalendarControl'].style.display = 'none';		
		document.all['XtremeTaskPanel'].style.display = 'none';		
		document.all['XtremeShortcutBar'].style.display = 'none';
		document.all['XtremeSyntaxEdit'].style.display = 'none';			
		document.all['XtremeMarkup'].style.display = 'none';
		document.all['XtremeChartControl'].style.display = 'none';		
		document.all['XtremeFlowGraph'].style.display = 'none';

		if (document.all['NotChartControl'] != null) {
			document.all['NotChartControl'].style.display = 'none';
		}

		if (objectID == 'XtremeChartControl') {
		     if (document.all['XtremeChartControl2'] != null) {
  			 //document.all['XtremeChartControl1'].style.display = 'none';
 		         document.all('XtremeChartControl2').style.display = 'none';
		      }
		}

	     if (document.all['XtremeChartControl'] != null) {
		         if (document.all['NotChartControl'] != null) {
				document.all('NotChartControl').style.display = 'block';
				}
		      }

		
		if (document.all['Common'] != null) {
			document.all['Common'].style.display = 'none';	
		  	document.all['Skin'].style.display = 'none';			
		  	
			if (objectID == 'XtremeSkinFramework'){
				document.all['Skin'].style.display = '';
			}
			else {
				document.all['Common'].style.display = '';
			}				  	
		}
		...
		if (objectID == 'XtremeChartControl') {
		     if (document.all['XtremeChartControl2'] != null) {
            	         //document.all('XtremeChartControl1').style.display = 'block';
 		         document.all('XtremeChartControl2').style.display = 'block';
		      }
		}
	} else 
	if (document.getElementById){
		document.getElementById('XtremeCommandBars').style.display = "none";	
		document.getElementById('XtremeDockingPane').style.display = "none";	
		document.getElementById('XtremePropertyGrid').style.display = "none";	
		document.getElementById('XtremeReportControl').style.display = "none";
		document.getElementById('XtremeCalendarControl').style.display = "none";		
		document.getElementById('XtremeSuiteControls').style.display = "none";							
		document.getElementById('XtremeSkinFramework').style.display = "none";									
		document.getElementById('XtremeTaskPanel').style.display = "none";							
		document.getElementById('XtremeShortcutBar').style.display = "none";
		document.getElementById('XtremeSyntaxEdit').style.display = "none";		
		document.getElementById('XtremeMarkup').style.display = "none";
		document.getElementById('XtremeChartControl').style.display = "none";		
		document.getElementById('XtremeFlowGraph').style.display = "none";	
		document.getElementById('NotChartControl').style.display = "none";	

		if (objectID == 'XtremeChartControl') {
                     if (document.getElementById('XtremeChartControl2') != null) {
                            //document.getElementById('XtremeChartControl1').style.display = "none";
        		    document.getElementById('XtremeChartControl2').style.display = 'none';
                     }
		}

	     if (document.getElementById('XtremeChartControl') != null) {
		         document.getElementById('NotChartControl').style.display = 'block';
		      }

		
		if (document.getElementById('Common') != null) {
		...
		if (objectID == 'XtremeChartControl') {
                     if (document.getElementById('XtremeChartControl2') != null) {
		          //document.getElementById('XtremeChartControl1').style.display = 'block';
        		    document.getElementById('XtremeChartControl2').style.display = 'block';
                     }
		}
	}
}
...
{
    internalToggleVisibilityEx(imgID, divID, false, "", false, false, "aximages/sectionplus.png", "aximages/sectionminus.png");
}
...
function toggleVisibilityStored(storeID)
{
    ...
    internalToggleVisibilityEx(imgID, divID, true, storeID, false, false, "aximages/sectionplus.png", "aximages/sectionminus.png");
}
...
function doShowHideCollapsedId(id, visible)
{
    ...
    internalToggleVisibilityEx(imgid, divid, false, "", !visible, visible, "aximages/sectionplus.png", "aximages/sectionminus.png");
}
